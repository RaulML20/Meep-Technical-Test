package com.example.meeptest.navigation
...
import com.example.androidroom.view.MainActivity
...
fun AnimationSplashScreen(context : Context) {
    ...
    Surface(modifier = Modifier
        ...
        Column(modifier = Modifier.padding(1.dp),
            ...
            Image(painter = painterResource(id = R.drawable.meep_icon),
                contentDescription = "meep icon",
